...
setlocal EnableDelayedExpansion
set file4=%~1
C:\temp\curl-7.33.0-win64-nossl\curl.exe -X GET  http://localhost:9004/dpa-api/control-panels/%file4% -H "Content-Type:application/vnd.emc.apollo-v1+xml" -H "Accept:application/vnd.emc.apollo-v1+xml" -u administrator:administrator > C:\temp2\%file4%.txt
goto :eof
