...
curl -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -d '
   <license lastModified="2012-04-23T12:45:08.337Z">
      <name>1 Celerra NS480 licenses for EMC (347915)</name>
      ...
      <sig>MCwCFAguQtR5a1cD4dLPK3UompAhAkPsAhQPnFCKxuw8fLaYaVyt5ZWfnqzHOA==</sig>
   </license>
' -X POST "$URL1"
