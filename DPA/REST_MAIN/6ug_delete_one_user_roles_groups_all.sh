...
echo
echo
echo "To DELETE All Groups list for given UserRole"
echo
echo "CHOOSE ROLE"
...
echo
curl -v -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -X DELETE "$URL1"/"$role1_id"/groups
echo
