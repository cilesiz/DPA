...
echo
echo -n "Choose Dashboard to DELETE [ No / Fullname / ID ] : "
read -e agentnak
...
echo
curl -v -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -X DELETE "$URL1"/"$dashboard_id"
echo
echo
