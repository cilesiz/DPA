...
echo
echo
echo "To check Dashboards list for given UserRole"
echo
echo "CHOOSE ROLE"
...
echo
curl -v -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -X GET "$URL2"/"$role1_id"/dashboards
echo
