...
user1=administrator
pswd1=administrator
idtukar=ad9ce1d8-90f0-4095-a08a-782fadf822a3
...
echo "  <displayName>dcp_all</displayName> " >> tmp11.xml
echo "  <logonName>dcp_all</logonName> " >> tmp11.xml
echo "  <externalName>dcp_all</externalName> " >> tmp11.xml
echo "  <password>dcp_all</password> " >> tmp11.xml
