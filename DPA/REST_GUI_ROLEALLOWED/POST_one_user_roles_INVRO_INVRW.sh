...
curl -v -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -X POST -d '
   <userRole version="1">
      <name>INVRW</name>
      <description>UserRole for a Inventory RW only</description>
      <permissions>
...
curl -v -u "$user1":"$pswd1" -H "Accept: application/vnd.emc.apollo-v1+xml" -H "Content-Type: application/vnd.emc.apollo-v1+xml" -X POST -d '
   <userRole version="1">
      <name>INVRO</name>
      <description>UserRole for a Inventory RO only</description>
      <permissions>
         <permission name="apollo.inventory.read">true</permission>
...
echo "  <displayName>inv_rw</displayName> " >> tmp11.xml
echo "  <logonName>inv_rw</logonName> " >> tmp11.xml
echo "  <externalName>inv_rw</externalName> " >> tmp11.xml
echo "  <password>inv_rw</password> " >> tmp11.xml
...
echo "  <displayName>inv_ro</displayName> " >> tmp22.xml
echo "  <logonName>inv_ro</logonName> " >> tmp22.xml
echo "  <externalName>inv_ro</externalName> " >> tmp22.xml
echo "  <password>inv_ro</password> " >> tmp22.xml
