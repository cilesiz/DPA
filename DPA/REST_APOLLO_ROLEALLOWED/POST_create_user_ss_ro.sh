...
user1=administrator
pswd1=administrator
idtukar=1edb69b6-366e-45d9-a3d6-cc51423f2b68
...
echo "  <displayName>ss_ro</displayName> " >> tmp11.xml
echo "  <logonName>ss_ro</logonName> " >> tmp11.xml
echo "  <externalName>ss_ro</externalName> " >> tmp11.xml
echo "  <password>ss_ro</password> " >> tmp11.xml
