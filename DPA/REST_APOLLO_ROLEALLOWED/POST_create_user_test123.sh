...
user1=administrator
pswd1=administrator
idtukar=667eff62-f9f3-4b75-9904-74108aef913a
...
echo "  <displayName></displayName> " >> tmp11.xml
echo "  <logonName>2</logonName> " >> tmp11.xml
echo "  <externalName></externalName> " >> tmp11.xml
echo "  <password>test1</password> " >> tmp11.xml
