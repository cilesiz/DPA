...
user1=administrator
pswd1=administrator
idtukar=d3c17cbe-de42-4bcb-9344-38a5afcf3bf0
...
echo "  <displayName>au_uis_111</displayName> " >> tmp11.xml
echo "  <logonName>au_uis_111</logonName> " >> tmp11.xml
echo "  <externalName>au_uis_111</externalName> " >> tmp11.xml
echo "  <password>au_uis_111</password> " >> tmp11.xml
