...
user1=administrator
pswd1=administrator
idtukar=eca34606-991b-40b7-958d-8442282c9bfa
...
echo "  <displayName>au_uis_0xx</displayName> " >> tmp11.xml
echo "  <logonName>au_uis_0xx</logonName> " >> tmp11.xml
echo "  <externalName>au_uis_0xx</externalName> " >> tmp11.xml
echo "  <password>au_uis_0xx</password> " >> tmp11.xml
