...
user1=administrator
pswd1=administrator
idtukar=3a6eb1d9-796a-4935-9685-7ffc7b394a3c
...
echo "  <displayName>au_uis_1xx</displayName> " >> tmp11.xml
echo "  <logonName>au_uis_1xx</logonName> " >> tmp11.xml
echo "  <externalName>au_uis_1xx</externalName> " >> tmp11.xml
echo "  <password>au_uis_1xx</password> " >> tmp11.xml
