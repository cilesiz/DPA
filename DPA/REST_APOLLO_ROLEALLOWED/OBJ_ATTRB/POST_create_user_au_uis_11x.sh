...
user1=administrator
pswd1=administrator
idtukar=9937b313-1ce4-4d44-aaa3-05af968a8281
...
echo "  <displayName>au_uis_11x</displayName> " >> tmp11.xml
echo "  <logonName>au_uis_11x</logonName> " >> tmp11.xml
echo "  <externalName>au_uis_11x</externalName> " >> tmp11.xml
echo "  <password>au_uis_11x</password> " >> tmp11.xml
