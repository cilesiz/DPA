...
user1=administrator
pswd1=administrator
idtukar=790b6638-387a-4f6f-8915-56fda6091e94
...
echo "  <displayName>au_uis_00x</displayName> " >> tmp11.xml
echo "  <logonName>au_uis_00x</logonName> " >> tmp11.xml
echo "  <externalName>au_uis_00x</externalName> " >> tmp11.xml
echo "  <password>au_uis_00x</password> " >> tmp11.xml
