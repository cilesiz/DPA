...
user1=administrator
pswd1=administrator
idtukar=8dfd6946-a0f1-4cfd-b26e-62d203ceeeaa
...
echo "  <displayName>ra_rw</displayName> " >> tmp11.xml
echo "  <logonName>ra_rw</logonName> " >> tmp11.xml
echo "  <externalName>ra_rw</externalName> " >> tmp11.xml
echo "  <password>ra_rw</password> " >> tmp11.xml
