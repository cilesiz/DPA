...
<scheduledReport version="1">
    <description>TEST BY ROSLI</description>
    ...
    <report><id></id><name>Filesystem Configuration</name></report>
    <window><id></id><name>Last Month</name></window>
    <!-- For user, does the UI want 'name' and or 'externalName'? -->
    <user><id></id><logonName>ss_rw</logonName></user>
    <!-- schedule may be empty, inferring that the scheduled report is not active. If supplied, either id or name can be specified -->
    <schedule><id></id><name>test1</name></schedule>
    <preScript></preScript>
    ...
    <publications>
        <publication>
            ...
            <emailBehavior>attach</emailBehavior>
        </publication>
    </publications>
    <nodeLinks>
