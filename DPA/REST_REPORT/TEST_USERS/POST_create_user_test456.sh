...
user1=administrator
pswd1=administrator
idtukar=047ed7c5-0c37-418e-abfa-0862f7adde14
...
echo "  <displayName>test456</displayName> " >> tmp11.xml
echo "  <logonName>test456</logonName> " >> tmp11.xml
echo "  <externalName>test456</externalName> " >> tmp11.xml
echo "  <password>test456</password> " >> tmp11.xml
