...
echo "  <displayName>ss_rw2</displayName> " >> tmp11.xml
echo "  <logonName>ss_rw2</logonName> " >> tmp11.xml
echo "  <externalName>ss_rw2</externalName> " >> tmp11.xml
echo "  <password>ss_rw2</password> " >> tmp11.xml
