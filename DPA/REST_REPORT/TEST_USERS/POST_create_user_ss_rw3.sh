...
echo "  <displayName>ss_rw3</displayName> " >> tmp11.xml
echo "  <logonName>ss_rw3</logonName> " >> tmp11.xml
echo "  <externalName>ss_rw3</externalName> " >> tmp11.xml
echo "  <password>ss_rw3</password> " >> tmp11.xml
