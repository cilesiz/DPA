...
user1=administrator
pswd1=administrator
idtukar=63678a46-fcbe-446b-9a9e-093af50c11b2
...
echo "  <displayName>st_rw</displayName> " >> tmp11.xml
echo "  <logonName>st_rw</logonName> " >> tmp11.xml
echo "  <externalName>st_rw</externalName> " >> tmp11.xml
echo "  <password>st_rw</password> " >> tmp11.xml
