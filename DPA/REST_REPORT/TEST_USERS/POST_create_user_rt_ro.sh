...
user1=administrator
pswd1=administrator
idtukar=11828c8d-b8a9-4b62-85ce-da5f93ba027c
...
echo "  <displayName>rt_ro</displayName> " >> tmp11.xml
echo "  <logonName>rt_ro</logonName> " >> tmp11.xml
echo "  <externalName>rt_ro</externalName> " >> tmp11.xml
echo "  <password>rt_ro</password> " >> tmp11.xml
