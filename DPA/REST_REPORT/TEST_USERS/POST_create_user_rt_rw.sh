...
user1=administrator
pswd1=administrator
idtukar=7a3b9540-cb53-422c-8c74-e7fb46c8f653
...
echo "  <displayName>rt_rw</displayName> " >> tmp11.xml
echo "  <logonName>rt_rw</logonName> " >> tmp11.xml
echo "  <externalName>rt_rw</externalName> " >> tmp11.xml
echo "  <password>rt_rw</password> " >> tmp11.xml
