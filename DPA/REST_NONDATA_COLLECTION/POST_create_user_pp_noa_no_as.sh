...
user1=administrator
pswd1=administrator
idtukar=299c4c18-4ab1-4ed9-912f-baa9b375ff73
...
echo "  <displayName>pp_noa</displayName> " >> tmp11.xml
echo "  <logonName>pp_noa</logonName> " >> tmp11.xml
echo "  <externalName>pp_noa</externalName> " >> tmp11.xml
echo "  <password>pp_noa</password> " >> tmp11.xml
