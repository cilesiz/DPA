...
user1=administrator
pswd1=administrator
idtukar=1daf5935-eb1b-4ebe-a6a8-3983b341dae0
...
echo "  <displayName>ap_now</displayName> " >> tmp11.xml
echo "  <logonName>ap_now</logonName> " >> tmp11.xml
echo "  <externalName>ap_now</externalName> " >> tmp11.xml
echo "  <password>ap_now</password> " >> tmp11.xml
