...
user1=administrator
pswd1=administrator
idtukar=4e84f25a-332e-4352-b33a-78b804d1c866
...
echo "  <displayName>cp_now</displayName> " >> tmp11.xml
echo "  <logonName>cp_now</logonName> " >> tmp11.xml
echo "  <externalName>cp_now</externalName> " >> tmp11.xml
echo "  <password>cp_now</password> " >> tmp11.xml
