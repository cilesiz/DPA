...
echo "  <displayName>admintwo</displayName> " >> tmp11.xml
echo "  <logonName>admintwo</logonName> " >> tmp11.xml
echo "  <externalName>admintwo</externalName> " >> tmp11.xml
echo "  <password>admintwo</password> " >> tmp11.xml
